  ...
  render() {
    return (
      <div>
        ...
        <SmallText>
          Strength: {this.state.character.powerstats.strength}
        </SmallText>
        <SmallText>
          Durability: {this.state.character.powerstats.durability}
        </SmallText>
        <SmallText>
          Intell: {this.state.character.powerstats.intelligence}
        </SmallText>
